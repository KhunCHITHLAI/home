...
$results=$ordercontrol->showOrder();
?>
...
<div class='float-right' style="border-radius:20px; margin:0 0 10px 0">
    <a href='createorder.php' class='btn btn-primary pull-right'>Create Order</a>
</div>
...
$iresults=$itemcontrol->itemName($iname);
include_once("controller/registercontroller.php");
$registercontrol=new RegisterController();
$cresults=$registercontrol->customerName($uname);
foreach ($iresults as $iresult) {
foreach ($cresults as $cresult) {
 ?>
<tr>
<td><?php echo $i++?> </td>
<td><?php echo $iresult['name'];?> </td>
<td><?php echo $result['itemqty'];?> </td>
<td><?php echo $cresult['firstname'];?>&nbsp;<?php echo $cresult['lastname'];?> </td>
<td><?php echo $result['voucherid'];?> </td>
<td><?php echo $result['orderdate'];?> </td>



<td><a class="btn btn-primary" href="orderview.php?id=<?php echo $result['id'];?>" ><i class="fa fa-eye"></i></a>&nbsp; &nbsp; <a class="btn btn-success" href="orderedit.php?id=<?php echo $result['id'];?>"><i class="fa fa-edit"></i></a>&nbsp; &nbsp; <a class="btn btn-danger" onclick="return deleteuser(<?php echo $result['id'];?>);"><i class="fa fa-trash"></i></a></td>
</tr>
