...
if(isset($_POST['register'])){
        ...
        $registerController->createRegister($input1,$input2,$input3,$input4,$input5,$input7);
...
<form method="POST" action="">
 ...
 <div class="row">
    ...
    <div style="text-align:center;" class="pt-4 pb-3">
        <button type="submit" name="register" id="reg" class="btn-primary" style="text-align: center;  width: 120px; height:40px;">ADD
        </button>
    </div>
</form>
</div>
